        ...
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          >
            ...
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>
              Need a break? Pause your subscription and we&apos;ll hold your
              spot.
            </p>
              ...
              <>
                  ...
                  {pausePresets.map((preset) => (
                    <button
                      ...
                      style={{
                        ...
                        color:
                          pauseDays === preset.days ? "#D97706" : "#6B7280",
                      }}
                    >
                      {preset.label}
                    </button>
                ...
                >
                  <p className="text-sm" style={{ color: "#92400E" }}>
                    ...
                    <strong>{pauseResumeLabel}</strong>. You won&apos;t be
                    charged during the pause.
                  </p>
                </div>
          ...
          >
            ...
            <p className="text-sm mb-4" style={{ color: "#6B7280" }}>
              Select weeks to skip. You&apos;ll receive a credit for each
              skipped week.
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-sm mb-4" style={{ color: "#D1FAE5" }}>
                      We value your membership. As a special offer, enjoy 20%
                      off your next monthly billing — that&apos;s only{" "}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm" style={{ color: "#991B1B" }}>
                          ...
                          You&apos;ll still have access until your current
                          billing period ends on April 5, 2026. Any remaining
