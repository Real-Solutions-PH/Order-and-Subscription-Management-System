...
const defaultTemplates = [
  {
    ...
    snippet: "Hi {customer_name}, your order {order_id} has been confirmed...",
  ...
  },
  {
    ...
    snippet: "Your order {order_id} is on its way to you...",
  ...
  },
  {
    ...
    snippet:
      "This is a reminder that your payment for order {order_id} is pending...",
    subject: "Payment Reminder - {order_id}",
  ...
  },
  {
    ...
    snippet: "Your subscription is up for renewal on {delivery_date}...",
  ...
  },
  {
    id: "welcome",
    name: "Welcome Email",
    snippet: "Welcome to PrepFlow, {customer_name}! We are excited...",
...
export default function SettingsPage() {
  ...
  const initialGeneral = useMemo(() => {
    if (tenantConfig) {
      const meta = (tenantConfig.operating_hours ?? {}) as Record<
        string,
        string
      >;
      return {
        ...
        address:
          ...
          "15th Floor, Tower One, Ayala Triangle, Makati City 1226",
      };
    }
    return {
  ...
  const [cutoffs, setCutoffs] =
    useState<Record<string, { day: string; time: string }>>(cutoffDefaults);
  ...
  const [templatesOverride, setTemplatesOverride] = useState<
    typeof initialTemplates | null
  >(null);
  const templates = templatesOverride ?? initialTemplates;
  const setTemplates = setTemplatesOverride;
  const [editingTemplate, setEditingTemplate] = useState<
    (typeof defaultTemplates)[0] | null
  >(null);
      ...
      (prev ?? []).map((t) =>
        t.id === editingTemplate.id
          ? {
              ...
              snippet: templateForm.body.substring(0, 60) + "...",
            }
          : t,
      ),
    );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-6 lg:flex-row">
        ...
        <div className="w-full lg:w-52">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  style={{
                    backgroundColor:
                      activeTab === tab.key ? "#1B4332" : "#FFFFFF",
                    color: activeTab === tab.key ? "#FFFFFF" : "#6B7280",
                    border:
                      activeTab === tab.key ? "none" : "1px solid #E5E7EB",
                  }}
                >
                  <Icon size={16} />
                  {tab.label}
          ...
          {/* Desktop vertical */}
          <div
            className="hidden rounded-xl bg-white p-3 shadow-sm lg:block"
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    style={{
                      backgroundColor:
                        activeTab === tab.key ? "#1B4332" : "transparent",
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={general.phone}
                      onChange={(e) =>
                        setGeneral((g) => ({ ...g!, phone: e.target.value }))
                      }
                      className="w-full rounded-lg px-3 py-2 text-sm"
                      style={{ border: "1px solid #E5E7EB", color: "#1A1A2E" }}
                    />
                    ...
                    >
                      ...
                      {method.enabled && method.id !== "cod" && (
                        <motion.div
                          initial={{ opacity: 0, height: 0 }}
                          animate={{ opacity: 1, height: "auto" }}
                          className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 pt-4"
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div
                              ...
                              onClick={() =>
                                showToast("QR Code upload clicked")
                              }
                            >
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            <Select
                              value={member.role}
                              onValueChange={(value) =>
                                handleTeamRoleChange(member.id, value)
                              }
            ...
            <>
              ...
              <div>
                ...
                <p className="mt-1 text-xs" style={{ color: "#6B7280" }}>
                  Available tokens: {"{customer_name}"}, {"{order_id}"},{" "}
                  {"{delivery_date}"}
                </p>
              </div>
            </>
