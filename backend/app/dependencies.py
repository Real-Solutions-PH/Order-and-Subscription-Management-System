...
def get_subscription_service(
    sub_repo: Annotated[object, Depends(get_subscription_repo)],
    plan_repo: Annotated[object, Depends(get_subscription_plan_repo)],
):
...
def get_order_service(
    order_repo: Annotated[object, Depends(get_order_repo)],
    cart_repo: Annotated[object, Depends(get_cart_repo)],
):
...
def get_notification_service(
    template_repo: Annotated[object, Depends(get_notification_template_repo)],
